...
class EyPluginComponent extends CakeObject
{
    ...
    private $reference = 'https://raw.githubusercontent.com/zinzin92/fivem-cms.org/main/market/plugins.json';
    ...
    public function download($slug, $install = false)
    {
        ...
        // get files
        $zip = $this->controller->sendGetRequest('https://github.com/zinzin92/Plugin-' . $slug . '/archive/master.zip');
        if (!$zip)
