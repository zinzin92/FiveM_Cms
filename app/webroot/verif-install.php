...
/*
 * @var array  $compatible         Dependencies for fivem-cms
...
if (!$compatible['rewriteUrl']) {
    ...
    if (!file_exists(ROOT . DS . ".htaccess")) {
        $help['rewriteUrl'] .= "Le fichier .htaccess semble manquant à la racine du site, activez les fichiers cachés et transférez le sur votre site depuis l'archive de fivem-cms. <br /><br />";
    }

    if (!file_exists(ROOT . DS . "app" . DS . ".htaccess")) {
        $help['rewriteUrl'] .= "Le fichier .htaccess semble manquant dans le dossier app/, activez les fichiers cachés et transférez le sur votre site depuis l'archive de fivem-cms. <br /><br />";
    }
